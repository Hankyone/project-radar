...
- Ghostty Pro Plus Ultra evidence: fixed split-pane click, drag, and release routing so mouse selection stays on the clicked terminal surface, with repeated-click and cross-divider regression coverage, commit `fb972a14c94192efdac4e817db9977fdb83bde46`.
- No new qualifying project added. Left RapidRecap unchanged because `f54f5624c9c9081465cfb2a8a448e03197e61d12` is primarily search metadata, redirects, route configuration, and a small archive-footer link. Ignored Ghostty release packaging `084a50eb7f04c8d2795914a2f75c19cdc1863bbe`, upstream merges, automated Maccy work, OpenOutposts snapshots, and Project Radar edits.
